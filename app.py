...
def default():
    return """<html>
        <head>
            <title>TED Talks Engagement Predictor API</title>
        </head>
        <body>
        <h1>TED Talks Engagement Predictor API</h1>
        <p>
            This is the API for the TED Talks Engagement Predictor application.
        </p>
        <p>
            Available endpoints:
        </p>
        <ul>
            ...
            <li>/api/predict - Prediction endpoint (POST)</li>
        </ul>
        </body>
        </html>""", 200
